...
///////////////////////////////////////////////////////////////////////////////
glm::vec3 Matrix3::getAngle() const
{
...
///////////////////////////////////////////////////////////////////////////////
Matrix4& Matrix4::translate(const glm::vec3& v)
{
...
///////////////////////////////////////////////////////////////////////////////
Matrix4& Matrix4::rotate(float angle, const glm::vec3& axis)
{
...
///////////////////////////////////////////////////////////////////////////////
Matrix4& Matrix4::lookAt(const glm::vec3& target)
{
    // compute forward vector and normalize
    glm::vec3 position = glm::vec3(m[12], m[13], m[14]);
...
Matrix4& Matrix4::lookAt(const glm::vec3& target, const glm::vec3& upVec)
{
    // compute forward vector and normalize
    glm::vec3 position = glm::vec3(m[12], m[13], m[14]);
    glm::vec3 forward = target - position;
    ...
    // compute left vector
    glm::vec3 left = glm::cross(upVec, forward);
    left = glm::normalize(left);
...
{
    return lookAt(glm::vec3(tx, ty, tz), glm::vec3(ux, uy, uz));
}
...
///////////////////////////////////////////////////////////////////////////////
Matrix4& Matrix4::skew(float angle, const glm::vec3& axis)
{
...
///////////////////////////////////////////////////////////////////////////////
glm::vec3 Matrix4::getAngle() const
{
    float pitch, yaw, roll;         // 3 angles
