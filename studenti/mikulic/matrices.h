...
public:
    ...
    void        setRow(int index, const glm::vec2& v);
    void        setColumn(int index, const float col[2]);
    void        setColumn(int index, const glm::vec2& v);
    ...
    glm::vec2     operator*(const glm::vec2& rhs) const;    // multiplication: v' = M * v
    ...
    friend glm::vec2 operator*(const glm::vec2& vec, const Matrix2& m); // pre-multiplication
...
public:
    ...
    void        setRow(int index, const glm::vec3& v);
    void        setColumn(int index, const float col[3]);
    void        setColumn(int index, const glm::vec3& v);

    const float* get() const;
    float       getDeterminant() const;
    glm::vec3     getAngle() const;                       // return (pitch, yaw, roll)
    ...
    glm::vec3     operator*(const glm::vec3& rhs) const;    // multiplication: v' = M * v
    ...
    friend glm::vec3 operator*(const glm::vec3& vec, const Matrix3& m); // pre-multiplication
...
public:
    ...
    void        setRow(int index, const glm::vec4& v);
    void        setRow(int index, const glm::vec3& v);
    void        setColumn(int index, const float col[4]);
    void        setColumn(int index, const glm::vec4& v);
    void        setColumn(int index, const glm::vec3& v);
    ...
    Matrix4&    translate(const glm::vec3& v);            //
    Matrix4&    rotate(float angle, const glm::vec3& axis); // rotate angle(degree) along the given axix
    ...
    Matrix4&    lookAt(const glm::vec3& target);
    Matrix4&    lookAt(const glm::vec3& target, const glm::vec3& up);
    //@@Matrix4&    skew(float angle, const glm::vec3& axis); //
    ...
    glm::vec4     operator*(const glm::vec4& rhs) const;    // multiplication: v' = M * v
    glm::vec3     operator*(const glm::vec3& rhs) const;    // multiplication: v' = M * v
    ...
    friend glm::vec3 operator*(const glm::vec3& vec, const Matrix4& m); // pre-multiplication
    friend glm::vec4 operator*(const glm::vec4& vec, const Matrix4& m); // pre-multiplication
...
inline void Matrix2::setRow(int index, const glm::vec2& v)
{
...
inline void Matrix2::setColumn(int index, const glm::vec2& v)
{
...
inline glm::vec2 Matrix2::operator*(const glm::vec2& rhs) const
{
    return glm::vec2(m[0]*rhs.x + m[2]*rhs.y,  m[1]*rhs.x + m[3]*rhs.y);
}
...
inline glm::vec2 operator*(const glm::vec2& v, const Matrix2& rhs)
{
    return glm::vec2(v.x*rhs[0] + v.y*rhs[1],  v.x*rhs[2] + v.y*rhs[3]);
}
...
inline void Matrix3::setRow(int index, const glm::vec3& v)
{
...
inline void Matrix3::setColumn(int index, const glm::vec3& v)
{
...
inline glm::vec3 Matrix3::operator*(const glm::vec3& rhs) const
{
    return glm::vec3(m[0]*rhs.x + m[3]*rhs.y + m[6]*rhs.z,
...
inline glm::vec3 operator*(const glm::vec3& v, const Matrix3& m)
{
    return glm::vec3(v.x*m[0] + v.y*m[1] + v.z*m[2],  v.x*m[3] + v.y*m[4] + v.z*m[5],  v.x*m[6] + v.y*m[7] + v.z*m[8]);
}
...
inline void Matrix4::setRow(int index, const glm::vec4& v)
{
...
inline void Matrix4::setRow(int index, const glm::vec3& v)
{
...
inline void Matrix4::setColumn(int index, const glm::vec4& v)
{
...
inline void Matrix4::setColumn(int index, const glm::vec3& v)
{
...
inline glm::vec4 Matrix4::operator*(const glm::vec4& rhs) const
{
...
inline glm::vec3 Matrix4::operator*(const glm::vec3& rhs) const
{
    return glm::vec3(m[0]*rhs.x + m[4]*rhs.y + m[8]*rhs.z + m[12],
...
inline glm::vec4 operator*(const glm::vec4& v, const Matrix4& m)
{
    return glm::vec4(v.x*m[0] + v.y*m[1] + v.z*m[2] + v.w*m[3],  v.x*m[4] + v.y*m[5] + v.z*m[6] + v.w*m[7],  v.x*m[8] + v.y*m[9] + v.z*m[10] + v.w*m[11], v.x*m[12] + v.y*m[13] + v.z*m[14] + v.w*m[15]);
}



inline glm::vec3 operator*(const glm::vec3& v, const Matrix4& m)
{
    return glm::vec3(v.x*m[0] + v.y*m[1] + v.z*m[2],  v.x*m[4] + v.y*m[5] + v.z*m[6],  v.x*m[8] + v.y*m[9] + v.z*m[10]);
}
